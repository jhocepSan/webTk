...
SELECT * FROM tkdb.llave WHERE idllave=349;
SELECT * from tkdb.pelea WHERE idllave=349;
UPDATE tkdb.llave SET idgrado=159,genero='M',idcategoria=107,idsubcategoria=676 WHERE idllave=342;

UPDATE tkdb.pelea set idcompetidor1=0,idganador=1577 WHERE idllave=349 AND idpelea=555;

INSERT INTO tkdb.pelea(idllave,idcompetidor1,idcompetidor2,idganador) 
VALUES (349,1888,1492,null);
...
SELECT * from tkdb.pelea where idllave=375 and (idcompetidor1=0 or idcompetidor2=0) and tipo=1

INSERT INTO tkdb.llave (tipo,idgrado,genero,idcategoria,idsubcategoria,idcampeonato)
VALUES ('C',158,'F',112,719,10);